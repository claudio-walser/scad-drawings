...
# echo "Generate SpindleGear 3D View"
# flatpak run org.openscad.OpenSCAD  --imgsize 1920,1080 --viewall --autocenter --camera=0,0,0,70,0,190,0 -o ../plans/spindleGear/spindleGear.png ../_view-spindleGear.scad


# # Spindelzahnrad
# echo ""
# echo "Generate SpindleGear Top Plan"
# flatpak run org.openscad.OpenSCAD --projection=ortho --imgsize 1920,1080 --viewall --autocenter --camera=0,0,0,0,0,0,0 -o ../plans/spindleGear/spindleGear-top.svg ../_projection-spindleGear-top.scad


# ### SpindleLock
# # 3D Ansicht

# echo "Generate SpindleLock 3D View"
# flatpak run org.openscad.OpenSCAD  --imgsize 1920,1080 --viewall --autocenter --camera=0,0,0,70,0,190,0 -o ../plans/spindleLock/spindleLock.png ../_view-spindleLock.scad


# # Spindelzahnrad
# echo ""
# echo "Generate SpindleLock Top Plan"
# flatpak run org.openscad.OpenSCAD --projection=ortho --imgsize 1920,1080 --viewall --autocenter --camera=0,0,0,0,0,0,0 -o ../plans/spindleLock/spindleLock-top.svg ../_projection-spindleLock-top.scad
...
# flatpak run org.openscad.OpenSCAD  --imgsize 1920,1080 --viewall --autocenter --camera=0,0,0,60,0,-120,0 -o ../plans/spindleHandle/spindleHandle.png ../_view-spindleHandle.scad


# # Spindelzahnrad
# echo ""
# echo "Generate SpindleHandle Top Plan"
# flatpak run org.openscad.OpenSCAD --projection=ortho --imgsize 1920,1080 --viewall --autocenter --camera=0,0,0,0,0,0,0 -o ../plans/spindleHandle/spindleHandle-top.svg ../_projection-spindleHandle-top.scad
...
echo "Generate SpindlePlatePin 3D View"
...
echo ""
echo "Generate SpindlePlatePin Top Plan"
...
echo "Generate SpindleFlange 3D View"
flatpak run org.openscad.OpenSCAD  --imgsize 1920,1080 --viewall --autocenter --camera=0,0,0,40,0,120,0 -o ../plans/spindleFlange/spindleFlange.png ../_view-spindleFlange.scad
echo ""
echo "Generate SpindleFlange Top Plan"
flatpak run org.openscad.OpenSCAD --projection=ortho --imgsize 1920,1080 --viewall --autocenter --camera=0,0,0,0,0,0,0 -o ../plans/spindleFlange/spindleFlange-top.svg ../_projection-spindleFlange-top.scad

echo ""
echo "Generate SpindleFlange Side Plan"
flatpak run org.openscad.OpenSCAD --projection=ortho --imgsize 1920,1080 --viewall --autocenter --camera=0,0,0,0,0,0,0 -o ../plans/spindleFlange/spindleFlange-side.svg ../_projection-spindleFlange-side.scad
